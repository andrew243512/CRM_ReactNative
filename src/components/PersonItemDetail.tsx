...
import * as actions from '../store/actions/person.action';
...
function PersonItemDetail(): JSX.Element {
  const isDarkMode = useColorScheme() === 'dark';
  const theme = getTheme();
  const person = useSelector(
    (state: {people: Person[]; peopleSelected: Person}) => state.peopleSelected,
  );
  return (
    <View
      style={[
...
const mapStateToProps = (state: {peopleSelected: {}}) => {
  return {
    ...state,
...
export default connect(mapStateToProps, actions)(PersonItemDetail);
